...
document.write ("<div class='head'>");
    document.write ("<div class='head_div'>");
        document.write ("<div class='head_left'>您好，欢迎来到<span>加密在线</span>！</div>");
        document.write ("<div class='head_right'><a href='#' class='to_ri_sp1'>按Ctrl+D</a><a href='#' class='to_ri_sp2'>加入收藏</a></div>");
    document.write ("</div>");
document.write ("</div>");
...
document.write ("<div class='top'>");
    document.write ("<div class='logo'><a href='https://dogecoin.com/' target='_blank'><img src='https://i.postimg.cc/kM8GmtrT/doge.jpg' width='230' height='100' alt='DOGE' title='狗狗币' /></a></div>");
    document.write ("<div class='date'>");
        ...
        document.write ("<a href='https://turtlecoin.lol/'target='_blank'><div class='adv1'><img src='https://i.postimg.cc/TPGqVXV6/trtl.jpg' width='178' height='85' alt='乌龟币' title='乌龟币' /></div></a>");
    document.write ("</div>");
document.write ("</div>");
document.write ("<div class='clear'></div>");
<!-- 头部（logo + 日期） end -->
...
document.write ("<div class='search'>");
    document.write ("<div class='ruzhu'><a href='#'><img src='images/ruzhu.png' width='208' height='55' alt='' title='' /></a></div>");
